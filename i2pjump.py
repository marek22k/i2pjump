...
parser.add_argument("--new-hosts", default="http://i2p-projekt.i2p/hosts.txt,http://identiguy.i2p/hosts.txt,http://joajgazyztfssty4w2on5oaqksz6tqoxbduy553y34mf4byv6gpq.b32.i2p/export/alive-hosts.txt", help="http proxy to use")
...
def doIndex(self):
    ...
    self.output("<br>\n<br>\n<p>Use jump service by visiting '/jump/JUMP_DESTINATION'</p>\n")
    self.output("\n<p>Full list of hosts available at <a href=\"/hosts\">/hosts</a>\n")
    self.output("\n<p>Stats available at <a href=\"/stats\">/stats</a>\n")
